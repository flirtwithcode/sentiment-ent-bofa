...
export class Chart4Component {
  @ViewChild('myCanvas4') canvas: ElementRef;
      ...
      custom: function (tooltipModel) {
        ...
        if (htmlDom == null) {
          const toolTips = [
            ...
            `<div style=' margin:-70% 0 0 140%; height:100px;width:160px;background-color: #fce7ce;color: #000;padding: 10px;box-shadow: 0 0 3px 3px #fce7ce; border-radius: 5px;'>Client is emailed that <br>eBill pay option has <br>accepted for 
            <br>selected biller</div><br>
            <div style='margin:0% 0 0 -20%; height:50px;width: 150px;background-color: #fce7ce;color: #000;padding: 10px;box-shadow: 0 0 3px 3px #fce7ce; border-radius: 5px;'>Client account with  <br/biller is linked to BofA <br/> account </div>
          <br/>
          
         `,

            `<div style='margin: -60% 0 0 120%; height:70px;width: 165px;background-color: #ddc4f0;color: #000;padding: 10px;box-shadow: 0 0 3px 3px #ddc4f0; border-radius: 5px;'>Publish confirmation 
          <br> page</div><br/>`,
